...
//
// Two-phase logout:
//  1. POST /api/auth/revoke  → tells Drupal to invalidate the access_token
//  2. signOut()              → clears the NextAuth JWT cookie client-side
//
// If Drupal revocation fails (network error, Drupal down) we still clear
// the local session — the token will expire naturally on Drupal's side.
